...
== Backlog:
 * Move board down, pieces all around
 * Project commit to a new repository
 * When pieces collection fetched at BB.js, randomly rotate them before displaying
 * Frontend: shuffle div models and randomly select the same amount as of pieces 
