...
SATERDAY:
 ...
 3. Fix bug with the cover not overlapping the pieces REMOVE THE COVER
 6. Marks should overlap pieces on reload
 - fix hidden_div shifting main board up
 - there should be a button in order to get back to the gallery?