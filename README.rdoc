...
b. we can reset completely session, deleting as usual with destroy_record + add the deletion of image_reference there
 ...
 - http://localhost:3000/assets/copengagen_bicycle_alley.jpg,
   http://localhost:3000/assets/prague_building.jpg,
   http://localhost:3000/assets/geisha_4.jpg

  is too long and has some bug at loading pieces and the board.