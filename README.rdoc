...
SATERDAY:
 2. Add all the pictures from collection to the app, save them in the db
 3. Cut all images, save pieces to the db
 3. Fix bug with the cover not overlapping the pieces
 4. Pieces should be bigger
 ...
 1. write reduce for the view and return categories properly from backend
 5. compare what images where registered in the db/imagen 
 file/displayed forntend and see what images are missing
