...
b. we can reset completely session, deleting as usual with destroy_record + add the deletion of image_reference there
 ...
 Smaller picture means less memory consuming and faster browser uploading process. DONE
 ...
 - Make pieces size, cells size be defined in one place and variable shared