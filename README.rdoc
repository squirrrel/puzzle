...
b. we can reset completely session, deleting as usual with destroy_record + add the deletion of image_reference there
 ...
 - 2.Either improve slow performance or show a progress bar whenever images or pieces are loaded 
 ...
 - 1.bug overlapping two pieces simultaneously

 - Background job for deleting outdated sessions

 - OPTIMIZE THE APP:

 - keep images in redis/read on redis scaling/images load will be way faster when assets precompiled
