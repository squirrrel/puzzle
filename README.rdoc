...
SATERDAY:
 ...
 - Marks should overlap pieces on reload
 - fix hidden_div shifting main board up
 - there is a bug of matched pieces loosing their property on going back to current puzzle
 - there is a bug when going back to the gallery there is an extra scroll and image layout is altered
  

 - check the button hide/show workflow
 - check the hide/show/remove current_session workflow
